            ...
            <nav class="navbar-default navbar-side" role="navigation">
                <div class="sidebar-collapse">
                    <ul class="nav" id="main-menu">
                        ...
                        <li>
                            <a class="active-menu" href="index.php"><i class="fa fa-globe"></i>Inicio</a>
                        </li>
                        <li>
                ...
                <div id="page-inner">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <h1 class="page-subhead-line">Como graduando, tiene la posibilidad de registrar una cantidad determinada de invitados para la(s) ceremonia(s) en la(s) que participará.
                                <!--<br><b style="color: #e70d2d;">De <a href="InstructivoGraduandos.pdf"  style="color:#0042FF" download>clic aquí </a>para descargar instructivo.</b> -->
                            </h1><br>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            <center> <img src="assets/img/gradoImg.png" alt="usbbog" class="responsive-img" style="width: 300px; height: 350px;"></center>
                        </div>
                    </div>
                </div>
            </div>
