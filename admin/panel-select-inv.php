            ...
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <h1 class="page-subhead-line">Seleccione un filtro para consultar la información de los invitados.
                        </h1>
                    </div>
                </div>
                        ...
                        <div class="panel-body">
                            <div class="form-container">
                                <div class="col-xs-12 col-sm-6">
                                    <form method="POST" action="tableI.php" class="form-horizontal">
