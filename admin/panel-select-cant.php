            ...
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <h1 class="page-subhead-line">Seleccione el ciclo a consultar para la modificación de cantidad de invitados por graduando.
                        </h1>
                    </div>
                </div>
                        ...
                        <div class="panel-body">
                            <div class="form-container">
                                <div class="col-xs-12 col-sm-6">
                                    <form method="POST" action="panel-cant.php" class="form-horizontal">
                                        <div class="form-group">
                                            <label for="opcS1" class="col-xs-12">Seleccione Ciclo:</label>
                                            <div class="col-xs-12">
                                                <select class="form-control custom-select" id="opcS1" name="opcS1" style="margin-bottom: 10px;">
                                ...
                                <div class="col-xs-12 col-sm-6">
                                    <form method="POST" action="panel-cant.php" class="form-horizontal">
                                        <div class="form-group">
                                            ...
                                            <div class="col-xs-12">
                                                <select class="form-control custom-select" id="opcS2" name="opcS2" style="margin-bottom: 10px;">
                                                    <option value="" selected>SELECCIONE</option>
                                                    <?php
                    ...
                    <div class="col-md-12">
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <center>
                                        <img src="assets/img/gradoImg.png" alt="usbbog" class="responsive-img" style="width: 300px; height: 350px; margin-top: -20px;">
                                    </center>
                                </div>
                            </div>
                        </div>
